...
public class Task {
     ...
     */
    public Task removeEmployee(int employeeId) throws CommandException {
    ...
    public void removeAssignments() {
        for (int employeeId : employees.getAssignedEmployees().keySet()) {
            ...
            try {
                employee.removeTask(taskId.getId());
